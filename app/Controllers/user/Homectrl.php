...
use App\Models\ArtikelModel; // Add the ArtikelModel
...
class Homectrl extends BaseController
{
    ...
    private $SliderModel;
    private $ProdukModel;
    private $ArtikelModel; // Declare the ArtikelModel
    ...
    public function __construct()
    {
        ...
        $this->ArtikelModel = new ArtikelModel(); // Initialize the ArtikelModel
    }
    ...
    public function index()
    {
        $data = [
            ...
            'artikelterbaru' => $this->ArtikelModel->findAll(), // Ambil artikel yang tampil di website
        ];
    ...
    // Add the new method to display the articles
    public function articles()
    {
        $data = [
            'profil' => $this->ProfilModel->findAll(),
            'tbartikel' => $this->ArtikelModel->findAll(),
        ];
        ...
        return view('user/articles/index', $data);
    }
}
